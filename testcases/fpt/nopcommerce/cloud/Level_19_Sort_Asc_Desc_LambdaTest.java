...
public class Level_19_Sort_Asc_Desc_LambdaTest extends BaseTest {
	WebDriver driver;
	AdminLoginPO adminLoginPage;
	AdminProductsPO adminProductsPage;

	@Parameters({ "browser", "appUrl", "osName", "browserVersion" })
	@BeforeClass
	public void beforeClass(String browserName, String appUrl, String osName, String browserVersion) {
		driver = getBrowserDriverLamdaTest(browserName, appUrl, osName, browserVersion);
