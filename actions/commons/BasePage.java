...
public class BasePage {
	...
	protected String getText(WebDriver driver) {
	...
	protected void selectItemInCustomDropdownList(WebDriver driver, String parentXpath, String childXpath, String expectedTextItem) {
	...
	protected String getElementCssValue(WebDriver driver, String xpathLocator, String popertyName) {
		return getWebElement(driver, xpathLocator).getCssValue(popertyName);
	}
